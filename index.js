...
function getWeatherByGeo( lat, lon ) {
	...
	var url = "https://api.openweathermap.org/data/2.5/weather?" + "lat=" + lat + "&lon=" + lon + "&units=imperial" + "&apikey=" + APIKEY;
...
function getWeatherByZip() {
	...
	var url = "https://api.openweathermap.org/data/2.5/weather?" + "zip=" + zip + ",us" + "&apikey=" + APIKEY;
	xhttp.open( "GET", url, true );
	xhttp.send();
	console.log( url );
}
